    ...
    <div class="navbar navbar-inverse navbar-fixed-top hidden-xs hidden-sm">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="logo" href="#"><h3 class="white">FORTRAN|For the Registered Generation</h3></a>
        </div>
      ...
      <div class="container">
        ...
        <div class="row1 header-info">
          <div class="col-sm-10 col-sm-offset-1 text-center">
            ...
            <br />
            <p class="lead wow fadeIn" data-wow-delay="0.5s">{{ ucfirst(config('app.kata_kunci')) }}</p>
            <br />
          ...
          <div class="col-sm-8 col-sm-offset-2 text-center">
            ...
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form role="form" action="{{asset('/nilai')}}" method="POST">
...
<!--             <a href="#" target="_blank">
            ...
            <p class="black">Perbedaan bukan memecahkan, namun dari perbedaan bisa muncul sebuah kebersamaan, keakraban, dan keharmonisan. Dan itu akan kamu wujudkan dalam FORTRAN {{ config('app.angkatan') }}<br />
    ...
    <footer>
      <div class="container">
          <div class="col-sm-12 text-center">
            <p><small>Copyright &copy; {{ config('app.angkatan') }}. All rights reserved. <br>
